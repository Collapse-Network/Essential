 ...
 * @method static CeilingCenterHangingSign BAMBOO_CEILING_CENTER_HANGING_SIGN()
 * @method static CeilingEdgesHangingSign BAMBOO_CEILING_EDGES_HANGING_SIGN()
...
final class VanillaBlocks{
	...
	protected static function setup() : void{
		...
		self::register("grindstone", fn(BID $id) => new Grindstone($id, "Grindstone", new Info(BreakInfo::pickaxe(3.0, ToolTier::WOOD(), 15.0))), TileGrindstone::class);

		self::register("dropper", fn(BID $id) => new Dropper($id, "Dropper", new Info(BreakInfo::pickaxe(3.0, ToolTier::WOOD(), 15.0))), TileDropper::class);

		self::register("scaffolding", fn(BID $id) => new Scaffolding($id, "Scaffolding", new Info(BreakInfo::pickaxe(0.4))), TileScaffolding::class);
	...
	private static function registerWoodenBlocks() : void{
		...
		self::register("bamboo_mosaic", fn(BID $id) => new Planks($id, "Bamboo Mosaic", $planksBreakInfo, WoodType::BAMBOO));
		self::register("bamboo_mosaic_slab", fn(BID $id) => new WoodenSlab($id, "Bamboo Mosaic", $planksBreakInfo, WoodType::BAMBOO));
		self::register("bamboo_mosaic_stairs", fn(BID $id) => new WoodenStairs($id, "Bamboo Mosaic Stairs", $planksBreakInfo, WoodType::BAMBOO));
	}
