...
final class BlockObjectToStateSerializer implements BlockStateSerializer{
	...
	private function registerSimpleSerializers() : void{
		...
		$this->mapSimple(Blocks::OBSERVER(), Ids::OBSERVER);
	...
	private function registerSerializers() : void{
		...
		$this->map(Blocks::CHAIN(), function(Chain $block) : Writer{
			return Writer::create(Ids::IRON_CHAIN)
				->writePillarAxis($block->getAxis());
		});
		...
		$this->map(Blocks::GRINDSTONE(), function(Grindstone $block) : Writer{
			return Writer::create(Ids::GRINDSTONE)->writeString(StateNames::ATTACHMENT, "standing")->writeInt(StateNames::DIRECTION, 3);
		});
		...
		$this->map(Blocks::SCAFFOLDING(), function(Scaffolding $block) : Writer{
			return Writer::create(Ids::SCAFFOLDING)->writeInt(StateNames::STABILITY, 0)->writeBool(StateNames::STABILITY_CHECK, true);
		});
